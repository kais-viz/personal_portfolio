<template>
  <div class="px-6 py-24 bg-white isolate sm:py-32 lg:px-8">
    <div class="max-w-2xl mx-auto text-center">
      <h2 class="text-4xl font-semibold tracking-tight text-gray-900 text-balance sm:text-5xl">Let's Connect</h2>
    </div>
    <form action="#" method="POST" class="max-w-xl mx-auto mt-16 sm:mt-10">
