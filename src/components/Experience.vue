        ...
        <div class="relative pb-8">
          ...
          <div class="relative flex items-start space-x-3">
            <template v-if="activityItem.type === 'comment'">
              <div class="relative">
                <img class="flex items-center justify-center bg-gray-400 rounded-full size-10 ring-8 ring-white" :src="activityItem.imageUrl" alt="" />

                <span class="absolute -bottom-0.5 -right-1 rounded-tl bg-white px-0.5 py-px">
                  <ChatBubbleLeftEllipsisIcon class="text-gray-400 size-5" aria-hidden="true" />
                </span>
              </div>
            ...
            <template v-else-if="activityItem.type === 'assignment'">
              <div>
                <div class="relative px-1">
                  <div class="flex items-center justify-center bg-gray-100 rounded-full size-8 ring-8 ring-white">
                    <UserCircleIcon class="text-gray-500 size-5" aria-hidden="true" />
                  </div>
                </div>
              </div>
            ...
            <template v-else-if="activityItem.type === 'tags'">
              <div>
                <div class="relative px-1">
                  <div class="flex items-center justify-center bg-gray-100 rounded-full size-8 ring-8 ring-white">
                    <TagIcon class="text-gray-500 size-5" aria-hidden="true" />
                  </div>
                </div>
              </div>
              <div class="flex-1 min-w-0 py-0">
                <div class="text-gray-500 text-sm/8">
                  <span class="mr-0.5">
                    <a :href="activityItem.person.href" class="font-medium text-gray-900">{{ activityItem.person.name }}</a>
                    {{ ' ' }}
                    added tags
